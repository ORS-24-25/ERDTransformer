# Implements the farthers point sampling algorithm for point clouds. 
# Used to downsample the point clouds by selecting a subset of points that hold the maximum geometrical information.
